...
WindowsAppSDK doesn't support creating multiple windows in a separated thread. Although you can create a separated thread and then create a window in it, many behaviors still are not implemented, like sharing application resources.
